...
wget http://repo.mysql.com/apt/debian/pool/mysql-5.6/m/mysql-community/libmysqlclient18_5.6.45-1debian9_amd64.deb && dpkg -i libmysqlclient18_5.6.45-1debian9_amd64.deb
